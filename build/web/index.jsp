...
<html>
    ...
    <body class="p-3 mb-2 bg-body text-body">
        <center>
        <div class="container">
        <h1 style="color: #3AAFA9; font-size: 3rem; font-weight: bold;">Formulario empleados</h1>
        </div>
        </center>
...
<div class="modal-body">
  <form action="sr_empleado" method="post" class="form-group">
                ...
                <input type="text" name="txt_codigo" id="txt_codigo" class="form-control" placeholder="Primer nombre Segundo nombre" required>
                ...
                <input type="date" name="txt_fn" id="txt_fn" class="form-control" placeholder="00/00/0000" required>
                ...
                <br/>
                <button  name="btn_agregar" id="btn_agregar" value="agregar" class="btn btn-primary btn-lg"><i class="bi bi-floppy"></i> Agregar</button>
                <button  name="btn_modificar" id="btn_modificar" value="modificar" class="btn btn-success btn-lg"><i class="bi bi-pencil-square"></i> Actualizar</button>
                <button  name="btn_eliminar" id="btn_eliminar" value="eliminar" class="btn btn-danger btn-lg" onclick="javascript:if(!confirm('Desea eliminar'))return false"><i class="bi bi-trash"></i> Eliminar</button>
                <button type="button" class="btn btn-warning btn-lg" data-bs-dismiss="modal"><i class="bi bi-x"></i> Cerrar</button>
        ...
        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modal_empleado" onclick="limpiar()"><i class="bi bi-file-earmark-plus"></i> Nuevo</button>
