...
public class Empleado extends Persona{
    ...
    cn = new Conexion();
    cn.abrir_conexion();
    String query = "SELECT e.id_empleados AS id, e.codigo, e.nombres, e.apellidos, e.direccion, e.telefono, e.fecha_nacimiento, p.puesto AS puesto, e.id_puesto AS id_puesto FROM empleados e INNER JOIN puestos p ON e.id_puesto = p.id_puesto;";
